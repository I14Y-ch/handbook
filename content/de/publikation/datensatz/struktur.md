...
Für Attribute und Assoziationen kann mit `dcterms:conformsTo` angegeben werden, dass sich das Element auf ein I14Y-Konzept abstützt. Daten, die sich auf dieselben grundlegenden Definitionen beziehen, sind (teilweise) harmonisiert. Die `sh:order`-Eigenschaft definiert die Reihenfolge, in der Attribute und Assoziationen angezeigt werden. 
