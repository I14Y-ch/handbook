...
Das Kompetenzzentrum Datenbewirtschaftung (KDB) des Bundesamts für Statistik stellt die Instrumente zur Harmonisierung, Standardisierung und Mehrfachverwendung von Daten bereit. Die in der selben Sektion angesiedelte Gruppe Metadatenplattform (MDP) entwickelt die Interoperabilitätsplattform I14Y sowie opendata.swiss. Das KDB koordiniert die Standardisierung und Harmonisierung von Daten innerhalb der einzelnen Themenbereiche (z.B. Energie, Gesundheit, Mobilität, Landwirtschaft). Das BFS nimmt dabei die Aufgaben des _Swiss Data Stewards_ wahr. 
