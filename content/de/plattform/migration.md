---
title: Migration in die Public Cloud
slug: migration
...
__Die Migration in die Public Cloud wurde am Donnerstag, 27. November, um 17.30 Uhr abgeschlossen.__
...
| Migration Software PROD | ✅ | I14Y ist nun in der Public Cloud. |
| Aktivieren der Schreibrechte PROD | ✅ | Die Plattform kann wieder wie normal genutzt werden. |
...
__Ab Dienstag, 18.11.2025:__ Die [Abnahme-Umgebung](https://input.i14y-a.admin.ch) läuft nun in der Public Cloud und kann getestet werden, sofern die nötigen Zugänge vorhanden sind. Probleme sind an [i14y@bfs.admin.ch](mailto:i14y@bfs.admin.ch) zu melden. 
